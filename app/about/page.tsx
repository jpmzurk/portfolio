...
const AboutPage = () => {
  return (
    <div className="flex  max-w-5xl mx-auto  mt-12 flex-col ">
      <div className="flex gap-8 border-b-2 border-white pb-12 flex-col lg:flex-row mb-12">
        <div className="basis-1/2 order-2 lg:order-1">
          <p className="mb-6 text-2xl ">
            ...
            creating engaging UIs using React but also enjoy building and
            testing API&apos;s when the project calls for it.
          </p>
          <p className="mb-6 text-2xl">
